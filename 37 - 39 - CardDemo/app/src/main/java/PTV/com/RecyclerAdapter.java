...
//        ViewHolder element = new ViewHolder(viewHolder.itemView);
//        element.itemTitle.setText(titles[i]);
//        element.itemImage.setImageResource(images[i]);
//        element.itemDetail.setText(details[i]);
//    }
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Snackbar.make(v, "Click detected on item, position: " + position, Snackbar.LENGTH_LONG)
