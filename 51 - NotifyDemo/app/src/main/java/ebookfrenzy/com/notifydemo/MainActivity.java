package ebookfrenzy.com.notifydemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNotificationChanel("notifydemo.news",
                "NotifyDemo News",
                "Example News Channel");

    }

    protected void createNotificationChanel(String id, String name, String description)
    {
    ...
    protected void sendNotification(View view) {
        ...
        String channelID = "notifydemo.news";
